...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Adding an click event for undo option.)
    ...
    fun paintClicked(view: View){
        // Check nút được click khác nút được click trước đó
    ...
    // Getting and bitmap Exporting the image to your phone storage.
    /**
    ...
    /** Create function to show the dialog
    ...
    /**Create function to cancel dialog
